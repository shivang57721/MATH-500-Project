...
# ╔═╡ 4b6d6122-9da6-4d22-b2d9-e6cbc241e230
...
# ╔═╡ e1427e4a-6cdd-486f-bbdd-941c5570afcf
#H_dir*x , N = 500
let
...
# ╔═╡ 26238f16-849e-4389-8b92-da17ac22fcb5
#H_dir\x , N = 500
let
	H = fd_hamiltonian_dirichlet(cos, 500);
	x = randn(size(H, 2));
...
# ╔═╡ e08a8c15-a942-4a46-a536-827be2dfd8d2
...
# ╔═╡ 665dd7c5-b470-485f-b521-a4d7ce3aed6b
...
# ╔═╡ 231840d1-f186-4f4b-9687-e184a1f61bf9
...
# ╔═╡ 42cee95e-aeef-4b13-a73b-42c70e41a159
...
# ╔═╡ b179372d-3c4a-4a1f-a40d-8b520465a2f2
let
	Xinit = randn(2000, 3)
...
# ╔═╡ bcde9720-5477-46f0-942f-a503aee62907
md"""
### Results of Task 1.2
...
# ╔═╡ 19190ad9-2be9-4be8-a02f-c60f2394d65d
begin
	# Define a range of Ecut values to test
	Ecut_values = 5:0.5:30
end

# ╔═╡ 89247bb6-f373-4c3c-b41e-a69a72c82936
begin
	# Initialize a matrix to store the results
	eigenvalues = zeros(length(Ecut_values), 2)
end

# ╔═╡ 207ddd3b-04fb-4d32-9529-a6e1af83765b
...
# ╔═╡ 7c53ba45-b516-4bb7-b789-498d5da857d7
eigenvalues

# ╔═╡ ba1ba08f-7fe5-4fb3-b736-adaf7200af08
md"""-------------"""

# ╔═╡ 855a34ed-c75d-439e-afa1-d5456e5e7ae6
begin
	# Plot the results
...
# ╔═╡ 9d1f5023-db24-4644-8eb3-b3de6f376997
begin
	# Plot the results
	#plot(Ecut_values, eigenvalues[:, 1], label="First Eigenvalue")
	plot(Ecut_values, eigenvalues[:, 2], label="Second Eigenvalue")
...
# ╔═╡ e4ef9978-2f19-4904-a5a3-62f832d9a0de
...
manifest_format = "2.0"
project_hash = "07d3dd8d5a6f907911bceb330c413704e15fcaf7"
